...
echo  "<td style='border: 0px'><input type='email' name='email' size =35></td>";
echo " </tr>";
echo  " <tr>";
echo  "<td style='border: 0px'>Password</td>";
echo  "<td style='border: 0px'><input type='password' name='password' size =35></td>";
echo  "</tr>";
echo "<tr>";
echo "<td style='border: 0px'><input type='reset' name='submitbtn' value='Clear Form'></td>";
echo "<td style='border: 0px; text-align: right;'><input type='submit' name='submitbtn' value='Login'></td>";
echo "</tr>";
echo "</table>";
echo "</form>";
